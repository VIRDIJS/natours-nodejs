...
exports.alerts = (req, res, next) => {
  ...
  if (alert === 'booking') {
    res.locals.alert =
      'Your booking was successful! Please check your email for confirmation. Allow some time for the booking to show up in your bookings.';
  }
  next();
};
...
exports.getTour = catchAsync(async (req, res, next) => {
  // 1. Get the data for the requested tour (with reviews and guides)
